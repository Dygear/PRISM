...
function console($line, $EOL = true, $fcolor = "white", $bcolor = "black")
{
    // example:
    // console("this is my exampletext", true, "light_green", "black");

    $ansi_fcolor_array = array( "black" => "0;30", 
                                "dark_gray" => "1;30",
                                "red" => "0;31",
                                "light_red" => "1;31",  
                                "green" => "0;32",
    ...
    $ansi_bcolor_array = array( "black" => "40",
                                "red" => "41",
                                "green" => "42",
                                "yellow" => "43",
                                "blue" => "44",
    ...
    echo "\033[".$ansi_fcolor_array[$fcolor]."m\033[".$ansi_bcolor_array[$bcolor]."m".$line. "\033[0m" . (($EOL) ? PHP_EOL : '');
}
