...
namespace PRISM\Module\Functions { # Getting better... Almost a module.

    # This needs to be dealt with, it's currently not a module...
    ...
    function get_dir_structure($path, $recursive = TRUE, $ext = NULL) //PHP Now has shit to deal with this...
    {
    	$return = NULL;
    	if (!is_dir($path))
    	{
