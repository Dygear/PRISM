...
# Since we are namespacing shit, everything should have the expanded name for semantic purposes
# But I don't really know the full names I'm not familiar enough with this game or codebase.
# Also, WTF abstract class Struct is just wrong... for being named Struct...
# This must be fixed...

# PSR?
# Major Clusterfuck, Must Fix /w proper names/rearrangement.

namespace PRISM\Module; //Am Have Must Look More Close Size Big
