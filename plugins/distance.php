	...
	public function onMCI($Packet) {
		...
		foreach ($Packet->Info as $CompCar) {
			...
			if (!isset($this->BTNs[$PLID])) {
				...
				$this->BTNs[$PLID]['X']->ClickID(3)->T(184)->L(26)->W(25)->H(6)->BStyle(ISB_DARK + 4)->Send();
				...
				$this->BTNs[$PLID]['Y']->ClickID(4)->T(184)->L(51)->W(25)->H(6)->BStyle(ISB_DARK + 1)->Send();
				...
				$this->BTNs[$PLID]['Z']->ClickID(5)->T(184)->L(76)->W(25)->H(6)->BStyle(ISB_DARK + 5)->Send();
				...
				$this->BTNs[$PLID]['Dist']->ClickID(6)->T(184)->L(101)->W(25)->H(6)->BStyle(ISB_DARK + ISB_RIGHT + 3)->Send();
				...
				$this->BTNs[$PLID]['Totl']->ClickID(7)->T(184)->L(126)->W(25)->H(6)->BStyle(ISB_DARK + ISB_RIGHT + 6)->Send();

				# These would be the bit length display buttons.
				$this->BTNs[$PLID]['Bits'] = new IS_BTN;
				$this->BTNs[$PLID]['Bits']->ClickID(47)->T(190)->L(101)->W(50)->H(6)->BStyle(ISB_LIGHT + ISB_RIGHT + 6)->Send();
				$this->BTNs[$PLID]['BitC'] = new IS_BTN;
				$this->BTNs[$PLID]['BitC']->ClickID(57)->T(190)->L(151)->W(12)->H(6)->BStyle(ISB_LIGHT + ISB_RIGHT + 4)->Send();


				$this->BTNs[$PLID]['MPS'] = new IS_BTN;
				$this->BTNs[$PLID]['MPS']->ClickID(8)->T(190)->L(26)->W(25)->H(6)->BStyle(ISB_LIGHT + 4)->Send();
				$this->BTNs[$PLID]['MPH'] = new IS_BTN;
				$this->BTNs[$PLID]['MPH']->ClickID(18)->T(190)->L(51)->W(25)->H(6)->BStyle(ISB_LIGHT + 4)->Send();
				$this->BTNs[$PLID]['KPH'] = new IS_BTN;
				$this->BTNs[$PLID]['KPH']->ClickID(28)->T(190)->L(76)->W(25)->H(6)->BStyle(ISB_LIGHT + 4)->Send();
